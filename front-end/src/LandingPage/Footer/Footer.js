      ...
      <div className="footer__container">
        <div className="footer-flex">
          <div className="wrapper">
            {Shop.map(function (i) {
              return (
                <Link href={i.url}>
                  <li key={i.title} className="footer__list">
                    {i.title}
                  </li>
                </Link>
              );
          ...
          <div className="wrapper">
            {Sell.map(function (u) {
              return (
                <Link href={u.url}>
                  <li key={u.title} className="footer__list">
                    {u.title}
                  </li>
                </Link>
              );
          ...
          <div className="wrapper">
            {Help.map(function (p) {
              return (
                <Link href={p.url}>
                  <li key={p.title} className="footer__list">
                    {p.title}
                  </li>
                </Link>
              );
        ...
        <div className="rest">
          <div className="footer_btn">
            ...
            <span className="span-btn">Download the Etsy App</span>
          </div>
